...
static lv_obj_t * build_launch_page(TodoListApp *app)
{    
    /* 创建基础页面容器 */
...
void todolist_view_launch_init_registry(TodoListApp *app)
{
    PAGE_REGISTE(app, PAGE_LAUNCH, build_launch_page);
}